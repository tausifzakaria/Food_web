    ...
    <>
      ...
      <div className='my-4 card shadow border-0 p-4 rounded-4'>
        <div className='row row-cols-1 row-cols-md-1 row-cols-lg-2 justify-content-center align-items-start'>
          <div className='col'>
            <img src={meal?.thumbnail} className='img-fluid rounded-4' alt="mealImage" />
          </div>
          <div className='col'>
            ...
            <div className='py-4 border-top'>
              ...
              <div className='d-flex my-3'>
                ...
                <div className='text-muted'>
                  <a className='text-decoration-none text-dark' href={meal.source}>
        ...
        <div className='bg-light p-3 my-3 rounded-4'>
          <h3>Measure:</h3>
          <ul className='row row-cols-2 align-items-center'>
            {
